...
const buttonGroupVariants = cva( 
  "flex w-fit items-stretch [&>*]:focus-visible:z-10 [&>*]:focus-visible:relative [&>[data
slot=select-trigger]:not([class*='w-'])]:w-fit [&>input]:flex-1 has-[select[aria
hidden=true]:last-child]:[&>[data-slot=select-trigger]:last-of-type]:rounded-r-md has
